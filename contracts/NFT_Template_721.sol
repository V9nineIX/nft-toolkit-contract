...
contract ERC721 is Initializable, Context, ERC165, IERC721, ERC2981, IERC721Metadata {
...
contract MyNFT is ERC721, Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        revealed = revealed_;
        sale = Sale(state_, maxTokensPerAddress_, price_);
        disableWhitelist = disableWhitelist_;
    }
    ...
    function setDisableWhitelist(bool _wl) public onlyOwner {
        disableWhitelist = _wl;
    }
