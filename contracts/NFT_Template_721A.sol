 ...
 */
contract ERC721A is Context, ERC165, IERC721A, Initializable {
...
contract Template721A is ERC721A, Ownable {
  using Strings for uint;
    ...
    uint public maxPublicSupply = 100;
    ...
    this.addPhase(
      ...
      function mint(uint _mintAmount) public payable {
       ...
       //TODO: get active state
        ...
        //require(currentPhase.isActive == true, "Sale Phase not active");
        require(currentPhase.status ==  LibSalePhase.STATE.START , "Sale Phase not start." );
       
        require(_mintAmount > 0, "You must mint at least 1 NFT");
      //  require(_numberMinted(msg.sender) + _mintAmount <= sale.maxTokensPerAddress, "Max tokens per address exceeded for this wave");
        require(_numberMinted(msg.sender) + _mintAmount <= currentPhase.maxPerWallet, "Max tokens per address exceeded for this wave");
       // require(_totalMinted() <= maxPublicSupply, "Max public supply exceeded");
        require(currentPhase.amountMinted+_mintAmount <=  currentPhase.maxSupply, "Max public supply exceeded");
        // require(msg.value >= sale.price * _mintAmount, "Please send the correct amount of ETH");
        require(msg.value >= currentPhase.price * _mintAmount, "Please send the correct amount of ETH");

        _safeMint(msg.sender, _mintAmount);

        LibSalePhase.setAmountMintedPhase(currentPhase.phaseNum  , _mintAmount ,msg.sender);
