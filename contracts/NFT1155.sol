...
contract Template1155 is ERC1155Factory, Pausable {
  ...
  uint256[] private _unusedURIKeys;
  ...
  function mint(uint256 amount, uint256 nonce, uint8 v, bytes32 r, bytes32 s) external payable whenNotPaused {
    ...
    require(mintableLeft() >= amount, "Not enough key left to mint.");
  ...
  function takeTokenIdRandom() private returns (uint256) {
    ...
    uint256 index = randomNum % mintableLeft();
